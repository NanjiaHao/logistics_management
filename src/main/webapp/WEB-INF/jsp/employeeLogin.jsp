...
<div class="content">
    <!-- BEGIN LOGIN FORM -->
    <form class="login-form" action="" method="post" id="empLoginForm">
        ...
        <div class="form-actions" style="text-align:center">
            <button type="button" class="btn btn-success login" id="empLogin">登录</button>
        </div>
    </form>
